...
namespace BusInCarparkTests.Tests.Functional{
    ...
    public class MoveBus<TWebDriver> where TWebDriver : IWebDriver, new()
    {
        ...
        public void BusCantExitCarpark()
        {
            ...
            singlePage.CheckBusIsInCorrectPosition(SinglePage<TWebDriver>.CoordinateX0Y4Locator, SinglePage<TWebDriver>.North);
            ...
            singlePage.CheckBusIsInCorrectPosition(SinglePage<TWebDriver>.CoordinateX4Y4Locator, SinglePage<TWebDriver>.East);
            ...
            SinglePage<TWebDriver>.GetInstance().CheckBusIsInCorrectPosition(SinglePage<TWebDriver>.CoordinateX4Y0Locator, SinglePage<TWebDriver>.South);
            ...
            SinglePage<TWebDriver>.GetInstance().CheckBusIsInCorrectPosition(SinglePage<TWebDriver>.CoordinateX0Y0Locator, SinglePage<TWebDriver>.West);
            ...
            SinglePage<TWebDriver>.GetInstance().CheckBusIsInCorrectPosition(SinglePage<TWebDriver>.CoordinateX0Y1Locator, SinglePage<TWebDriver>.North);
        }
